...
#Loading the values that go into the section dropdown on the Topic tab
section_labels = ['All']
...
layout_articles = html.Div() #Insert Kenan's section here

newswire_tabs = html.Div(dbc.Tabs([
    dbc.Tab(layout_search, label='Search for articles'),
    dbc.Tab(layout_topic, label='NY Times stats: Sections'),
    dbc.Tab(layout_geo, label='NY Times stats: Geographical mentions')
]))
